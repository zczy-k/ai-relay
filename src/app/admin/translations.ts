...
export const TRANSLATIONS = {
  zh: {
    ...
    setupKvFixTitle: '建议启用 Vercel KV 持久化能力',
    setupKvStep1: '在 Vercel Storage 中创建或连接 KV 数据库。',
    setupKvStep2: '确认项目环境变量中已自动注入 KV_REST_API_URL 与 KV_REST_API_TOKEN。',
    setupKvStep3: '重新部署后再运行检查；未配置 KV 时密钥管理、用量统计和配额会受限。',
  ...
  en: {
    ...
    setupKvFixTitle: 'Enable Vercel KV for persistence',
    setupKvStep1: 'Create or connect a KV database in Vercel Storage.',
    setupKvStep2: 'Confirm KV_REST_API_URL and KV_REST_API_TOKEN are injected into project environment variables.',
    setupKvStep3: 'Redeploy and run checks again; without KV, key management, usage stats, and quotas are limited.',
