...
export const TRANSLATIONS = {
  zh: {
    ...
    setupProviderKeysStep2: '在密钥池中粘贴原始 API Key 并保存；也可以在 Vercel 环境变量中配置对应的 *_KEYS。',
  ...
  en: {
    ...
    setupProviderKeysStep2: 'Paste the raw API key into the key pool and save; alternatively configure the matching *_KEYS env var in Vercel.',
